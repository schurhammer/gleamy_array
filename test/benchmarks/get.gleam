  ...
  bench.run(
    ...
    [
      bench.Function("gleamy_array", fn(x) {
        let #(a, x) = x
        list.each(x, fn(i) { array.get(a, i) })
      }),
    ],
    config.bench,
  )
  ...
  bench.run(
    ...
    [
      bench.Function("gleamy_array (unwrapped)", fn(x) {
        let #(a, x) = x
        list.each(x, fn(i) { array.unsafe_get(a, i) })
      }),
    ],
    config.bench,
  )
  ...
  bench.run(
    ...
    [
      bench.Function("erlang_array", fn(x) {
        let #(a, x) = x
        list.each(x, fn(i) { erlang_array.get(i, a) })
      }),
    ],
    config.bench,
  )
  ...
  bench.run(
    ...
    [
      bench.Function("glearray", fn(x) {
        let #(a, x) = x
        list.each(x, fn(i) { glearray.get(a, i) })
      }),
    ],
    config.bench,
  )
